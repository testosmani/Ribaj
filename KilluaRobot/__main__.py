...
from KilluaRobot.modules import ALL_MODULES
from KilluaRobot.modules.helper_funcs.chat_status import is_user_admin
from KilluaRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KilluaRobot.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Admin​", callback_data="Killua_admin"
                        ),
                        InlineKeyboardButton(
                            text="Notes", callback_data="Killua_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="Support​", callback_data="Killua_support"
                        ),
                        InlineKeyboardButton(
                            text="Credit​", callback_data="Killua_credit"
                        ),
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Go Back​", callback_data="Killua_back"
                        ),
                    ],
                ]
            ),
